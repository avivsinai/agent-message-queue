...
func TestWakeSelfUpgradeVersionStrictlyNewerTreatsBuildSuffixesConservatively(t *testing.T) {
	tests := []struct {
		incumbent string
		candidate string
		want      bool
		...
		{incumbent: "v1.0.0-rc.1", candidate: "1.0.0", want: false},
		{incumbent: "1.0.0-alpha", candidate: "1.0.0-beta", want: false},
		{incumbent: "1.0.0-beta.2", candidate: "1.0.0-beta.11", want: false},
