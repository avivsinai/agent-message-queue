...
func serve(args []string, stdout, stderr io.Writer) (int, error) {
	...
	// (Merged from the #802 durable-sender integration; attachments stay
	// gathered BEFORE startupSequence above, whose Reconcile must see them —
	// 611.22.19 round-4 P0.)
